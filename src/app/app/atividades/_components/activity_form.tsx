...
export default function ActivitiesDashboard() {
  ...
  const handleAddActivity = async () => {
    ...
    try {
      ...
      // Chamada para criar a atividade
      const response = await AtividadeService.createActivity(
        name as string,
      ...
      // Atualize o contexto com a nova atividade adicionando diretamente ao estado
